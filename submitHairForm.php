<?php
    ...
    $name = mysqli_real_escape_string($conn, $_POST['hair_name']);
    $email = mysqli_real_escape_string($conn, $_POST['hair_email']);
    $contact = mysqli_real_escape_string($conn, $_POST['hair_number']);
    $enquiry_treatment = mysqli_real_escape_string($conn, $_POST['hair_treatment']);
    $enquiry_comment = mysqli_real_escape_string($conn, $_POST['hair_comment']);
    ...
    if(mysqli_query($conn,"INSERT INTO enquiry(name, email, contact, treatment, comments, pagename, booked_date) VALUES ('$name','$email','$contact','$enquiry_treatment','$enquiry_comment','$pagename','$database_added_on')"))
    {
        ...
        try {
            ...
            $subject = 'Hair Health and Wellness - Hair Page Form';
